...
MAGIC_ITEMS = {
    ...
    "hat_disguise":         {"name":"Hat of Disguise",            "type":"Wondrous",     "rarity":"Common",    "attune":True,  "desc":"ร่ายคาถา Disguise Self ได้ตามต้องการ",             "price":65},
    "sending_stones":       {"name":"Sending Stones",             "type":"Wondrous",     "rarity":"Common",    "attune":False, "desc":"ส่งข้อความหากันได้ไม่จำกัดระยะ วันละ 1 ครั้ง",     "price":75},
    "potion_climbing":      {"name":"Potion of Climbing",         "type":"Potion",       "rarity":"Common",    "attune":False, "desc":"ได้รับ Climbing Speed = Walking Speed 1 ชม.",       "price":40},
    ...
    "silvered_weapon":      {"name":"Silvered Weapon",            "type":"Weapon",       "rarity":"Common",    "attune":False, "desc":"อาวุธเคลือบเงิน เอาชนะ damage resistance ของ lycanthrope/devil","price":60},
    # ── Uncommon ──────────────────────────────────────────────────────
    ...
    "boots_elvenkind":       {"name":"Boots of Elvenkind",        "type":"Wondrous",     "rarity":"Uncommon",  "attune":False, "desc":"Advantage บน Stealth checks ที่เกี่ยวกับเสียงก้าว", "price":400},
    "cloak_elvenkind":       {"name":"Cloak of Elvenkind",        "type":"Wondrous",     "rarity":"Uncommon",  "attune":True,  "desc":"Advantage บน Stealth / Disadvantage ต่อ Perception ที่เจอคุณ","price":450},
    ...
    "pearl_of_power":        {"name":"Pearl of Power",            "type":"Wondrous",     "rarity":"Uncommon",  "attune":True,  "desc":"คืน spell slot ระดับ 3 หรือต่ำกว่า 1 ครั้ง/วัน",   "price":400},
    ...
    "ring_protection":       {"name":"Ring of Protection",        "type":"Ring",         "rarity":"Uncommon",  "attune":True,  "desc":"+1 AC และ +1 ต่อ Saving Throws ทั้งหมด",           "price":500},
    "bracers_archery":       {"name":"Bracers of Archery",        "type":"Wondrous",     "rarity":"Uncommon",  "attune":True,  "desc":"+2 damage ต่อ ranged weapon attacks",               "price":400},
    "cloak_protection":      {"name":"Cloak of Protection",       "type":"Wondrous",     "rarity":"Uncommon",  "attune":True,  "desc":"+1 AC และ +1 ต่อ Saving Throws",                    "price":450},
    # ── Rare ──────────────────────────────────────────────────────────
    ...
    "weapon_plus2":          {"name":"Weapon +2",                 "type":"Weapon",       "rarity":"Rare",      "attune":False, "desc":"+2 bonus ต่อ attack rolls และ damage rolls",         "price":1200},
    "ring_spell_storing":    {"name":"Ring of Spell Storing",     "type":"Ring",         "rarity":"Rare",      "attune":True,  "desc":"เก็บ spell ได้สูงสุด 5 level ใช้ได้ทุกคน",         "price":1500},
    "necklace_adaptation":   {"name":"Necklace of Adaptation",    "type":"Wondrous",     "rarity":"Rare",      "attune":True,  "desc":"หายใจในสภาพแวดล้อมอันตรายได้ Adv. ต้าน inhaled poison","price":800},
    ...
    "ring_free_action":      {"name":"Ring of Free Action",       "type":"Ring",         "rarity":"Rare",      "attune":True,  "desc":"Immune ต่อ paralyzed, restrained จาก non-magic",    "price":2000},
    ...
    "staff_healing":         {"name":"Staff of Healing",          "type":"Staff",        "rarity":"Rare",      "attune":True,  "desc":"10 charges | Cure Wounds, Lesser Restoration, Mass Cure Wounds","price":1800},
    "amulet_health":         {"name":"Amulet of Health",          "type":"Wondrous",     "rarity":"Rare",      "attune":True,  "desc":"CON score = 19 ตราบใดที่สวมอยู่",                   "price":2500},
    # ── Very Rare ─────────────────────────────────────────────────────
    ...
    "weapon_plus3":           {"name":"Weapon +3",                "type":"Weapon",       "rarity":"Very Rare", "attune":False, "desc":"+3 bonus ต่อ attack rolls และ damage rolls",         "price":3500},
    ...
    "manual_golems":          {"name":"Manual of Golems",         "type":"Wondrous",     "rarity":"Very Rare", "attune":False, "desc":"คู่มือสร้าง Golem (Clay/Iron/Stone/Flesh)",          "price":5000},
    # ── Legendary ─────────────────────────────────────────────────────
    ...
    "armor_invulnerability":  {"name":"Armor of Invulnerability", "type":"Armor",        "rarity":"Legendary", "attune":True,  "desc":"Resistance ต่อ nonmagical damage, 10 min/day: Immune","price":12000},
    ...
    "holy_avenger":           {"name":"Holy Avenger",             "type":"Magic Weapon", "rarity":"Legendary", "attune":True,  "desc":"Paladin only | +3 atk/dmg | 10d10 radiant ต่อ undead/fiend","price":18000},
    "ring_djinni":            {"name":"Ring of Djinni Summoning", "type":"Ring",         "rarity":"Legendary", "attune":True,  "desc":"เรียก Djinni 1 ชม./วัน ใช้คำสั่งได้",              "price":20000},
