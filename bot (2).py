...
SHOPS = {
    ...
    "alchemist": {
        ...
        "desc": "ยาสมุนไพร ยาพิษ และอาวุธเวทย์ทุกชนิด "
                "ทุกขวดผ่านการกลั่นด้วยความประณีตจากอาจารย์ผู้เชี่ยวชาญเลยนะจะบอกให้!",
        "emoji": "🧪",
        "color": 0x8E44AD,
        "categories": {
    ...
    "general": {
        "name": "Market & General store",
        "npc":  "No one",
        "desc": "เป็นที่ๆทุกอย่างที่นักผจญภัยต้องการ ตั้งแต่เชือก ไปจนถึงเสื้อคลุม "
                "ราคายุติธรรม ของครบ ไม่ว่าคุณจะออกเดินทางไปไหน มั้งนะ",
        "emoji": "🎒",
        "color": 0x27AE60,
        "categories": {
